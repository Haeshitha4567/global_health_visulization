...
function setupCategoryFilters() {
    ...
    // Add category data attributes to visualization sections
    const vizSections = document.querySelectorAll('.viz-section');
    vizSections.forEach(section => {
    ...
    filterButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (category === 'all') {
                // Show all sections
                vizSections.forEach(section => {
                    section.closest('.viz-section').style.display = 'block';
                });
            } else {
                ...
                vizSections.forEach(section => {
                    if (section.getAttribute('data-category') === category) {
                        ...
                        section.closest('.viz-section').style.display = 'none';
                    }
                });
            }
        });
...
function setupSearch() {
    ...
    const dashboardOverview = document.querySelector('.dashboard-overview .container');
    if (dashboardOverview) {
        dashboardOverview.insertBefore(searchContainer, dashboardOverview.querySelector('.filter-container'));
    }
    ...
    searchInput.addEventListener('input', function() {
        ...
        if (searchTerm === '') {
            // Trigger click on "All Visualizations" filter button
...
function setupFullscreenButtons() {
    ...
    // Add fullscreen button to each visualization
    const vizSections = document.querySelectorAll('.viz-section');
    vizSections.forEach(section => {
