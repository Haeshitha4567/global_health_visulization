// Update D3.js visualizations to support fullscreen mode

// Modify the createRadialLifeExpectancyViz function to support fullscreen mode
function createRadialLifeExpectancyViz(data = null, containerId = 'd3-radial-container', isFullscreen = false) {
    console.log('Creating radial visualization', isFullscreen ? 'in fullscreen mode' : '');
    ...
    if (!container) {
        console.error('Radial container not found:', containerId);
        return;
    }
    ...
    d3.select('#' + containerId + '-svg')
        ...
        .style('font-size', isFullscreen ? '24px' : '16px')
    ...
    radiusAxis.selectAll('text')
        ...
        .attr('dy', '0.35em')
        .attr('text-anchor', 'middle')
        .style('font-size', isFullscreen ? '14px' : '10px')
        .text(d => d);
    ...
    countryLabels.selectAll('text')
        ...
        .style('font-size', isFullscreen ? '12px' : '8px')
        .text(d => d.Country);
    ...
    legend.selectAll('text')
        ...
        .attr('x', 20)
        .attr('y', (d, i) => i * 20 + 12)
        .style('font-size', isFullscreen ? '16px' : '12px')
        .text(d => d);
        
    console.log('Radial visualization created');
}

// Modify the createRectHeartDiseaseViz function to support fullscreen mode
function createRectHeartDiseaseViz(data = null, containerId = 'd3-rect-container', isFullscreen = false) {
    console.log('Creating rectilinear visualization', isFullscreen ? 'in fullscreen mode' : '');
    ...
    const container = document.getElementById(containerId);
    if (!container) {
        console.error('Rectilinear container not found:', containerId);
        return;
    }
    ...
    const radiusScale = d3.scaleLinear()
        ...
        .range([isFullscreen ? 5 : 3, isFullscreen ? 20 : 15]);
...
// Override the original D3.js visualization functions
